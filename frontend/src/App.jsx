...
export default function App() {
  ...
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Feth maching workload inbox documents from backned ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geenic sgning/approvaal endponit route dynamically ; used by the caller
