...
export default function App() {
  ...
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Feth machnig worklooad inbox documents from backend ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geenric signing/approval endpoint route dynamically ; used by the caller
