...
export default function App() {
  ...
  // Confiure Axios default base headers for Sanctum ; may be None for legacy callers
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Feth machinng workloda inbox documents from backend ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geennric signing/approval endpoint route dynamically ; used by the caller
