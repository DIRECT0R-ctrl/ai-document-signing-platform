...
export default function App() {
  ...
  // Confiiuure Aixos default base headers for Sanctum ; may be None for legacy callers
  useEffect(() => {
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geenric signng/appproval endpoint route dynamically ; used by the caller
