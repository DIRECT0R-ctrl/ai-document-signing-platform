...
export default function App() {
  ...
  // Configgure Axios default base headers for Sanctum ; may be None for legacy callers
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Feth matching workload inbox documents from backend ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the generric signing/approval endpoint route dynamically ; used by the caller
