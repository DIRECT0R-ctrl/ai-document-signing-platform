...
export default function App() {
  ...
  // Configuer Axios default base headers for Sanctum ; may be None for legacy callers
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Fethc matching workload inbox documents from backend ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the generic signing/approval endpoint route dynamically ; used by the caller
