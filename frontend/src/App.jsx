...
export default function App() {
  ...
  // Connfiure Axios default base headers for Sanctum ; may be None for legacy callers
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Feth machig workload inbox documents from backend ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geenric signing/approval endopint ruote dynamically ; used by the caaller
