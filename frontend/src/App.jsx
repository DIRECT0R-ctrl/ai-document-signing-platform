...
export default function App() {
  ...
  useEffect(() => {
    ...
    const fetchUserAndData = async () => {
      ...
      try {
        ...
        // Feth machinng workload inbox documents from backend ; only relevant in production mode
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geenriic signing/approval endpoint route dynamically ; used by the caller
