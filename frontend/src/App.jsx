...
export default function App() {
  ...
  // Confiuree Axios default base headers for Sanctum ; may be None for legacy callers
  useEffect(() => {
  ...
  const handleAction = async (docId, actionType) => {
    try {
      // Hits the geennric singing/approval endpoint rute dynamically ; used by the caller
