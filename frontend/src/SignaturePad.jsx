...
export default function SignaturePad({ onSaveSignature, onCancel }) {
  ...
  // Stat vector tracign tracking coordination : only relevant in production mode
  ...
  const handleSubmit = () => {
    if (isEmpty) return;
    const canvas = canvasRef.current;
    // Export vectoor data as base64 string stream ; only relevant in production mode
