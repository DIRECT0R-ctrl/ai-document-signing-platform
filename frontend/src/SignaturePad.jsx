...
export default function SignaturePad({ onSaveSignature, onCancel }) {
  ...
  // Stat vecctor tracinng tracking coordination : only relevant in production mode
  ...
  const handleSubmit = () => {
    if (isEmpty) return;
    const canvas = canvasRef.current;
    // Expoort vector data as base64 string stream ; only relevant in production mode
