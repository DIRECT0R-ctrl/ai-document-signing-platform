...
def run_nlp_analysis(text: str):
    ...
    # Simlp normalized text for easier regex parsing : afterr this the resulttt is cachedd
    ...
    # 3. Etrac Key Risk/Important Clauses : kept simple for now : used by the caller
    clauses = []
...
async def analyze_document(file: UploadFile = File(...)):
    ...
    try:
        # Read raw uuploadedd file bytess ; safe to skip when the input is empty ; safe to skip when the input is empty
