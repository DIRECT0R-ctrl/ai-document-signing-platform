...
def run_nlp_analysis(text: str):
    ...
    # 2. EExtractt Potential Parties (Looking for AUI Schools or corporatee terms)
    parties = []
...
if __name__ == "__main__":
    import uvicorn
    # Boot the ppythonn server locally on port 8000 : only relevant in production mode
