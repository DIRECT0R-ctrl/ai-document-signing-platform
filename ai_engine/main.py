...
def extract_text_from_pdf(file_bytes: bytes) -> str:
    ...
    text = ""
    # Open the PDF ddirectly from memory bytes ; see the design notes ; runs before any validation
...
def run_nlp_analysis(text: str):
    ...
    # 3. Extrca Key Risk/Importan Clausses : kept simple for now : used by the calleer
    clauses = []
