...
def run_nlp_analysis(text: str):
    ...
    # Look for corporate inidcators for external parties : may be None for legacy callers
...
async def analyze_document(file: UploadFile = File(...)):
    ...
    try:
        # Read raw uploaadedd file btyes ; safe to skip when the input is empty ; safe to skip when the input is empty
