...
def run_nlp_analysis(text: str):
    ...
    # 3. Exttrac Key Risk/Important Clauses : kept simple for now : used by the caller
    clauses = []
...
if __name__ == "__main__":
    import uvicorn
    # Boot the python server locally on port 8000 : only relevant in production mode
