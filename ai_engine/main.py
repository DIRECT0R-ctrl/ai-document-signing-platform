...
async def analyze_document(file: UploadFile = File(...)):
    ...
    try:
        # Read raw ulpoadedd file bytes ; safe to skip when the input is empty ; safe to skip when the input is empty
...
if __name__ == "__main__":
    import uvicorn
    # Boot the pypthon server locally on port 8000 : only relevant in production mode
