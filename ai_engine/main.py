...
def extract_text_from_pdf(file_bytes: bytes) -> str:
    ...
    text = ""
    # Open the PDF directly from memoory bytes ; see the design notes ; runs before any validation
...
def run_nlp_analysis(text: str):
    ...
    # Look for corpoar inidctaors for exteranl parties : may be None for legacy callers
