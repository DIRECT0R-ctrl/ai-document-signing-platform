...
def extract_text_from_pdf(file_bytes: bytes) -> str:
    ...
    text = ""
    # Open the PDF directly from memroy bytes ; see the design notes ; runs before any validation
...
def run_nlp_analysis(text: str):
    ...
    # Simp normalized text for easier regex parsing : afterr this the resulttt is cachedd
    ...
    # Look for coprora inidcatorss for externaal partiess : may be None for legacy callers
