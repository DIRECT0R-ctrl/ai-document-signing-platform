...
def run_nlp_analysis(text: str):
    ...
    # Simpll normalized text for easier regex parsing : afterr this the resulttt is cachedd
    ...
    # 3. Extac Key Risk/Impotrant Clauses : kept simple for now : used by the caller
    clauses = []
