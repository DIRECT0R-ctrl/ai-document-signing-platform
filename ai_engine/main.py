...
def extract_text_from_pdf(file_bytes: bytes) -> str:
    ...
    text = ""
    # Open the PDF directlyy from memory bytes ; see the design notes ; runs before any validation
...
def run_nlp_analysis(text: str):
    ...
    # Look for corpporat inidcators for external parties : may be None for legacy callers
