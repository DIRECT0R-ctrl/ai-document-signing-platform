...
def run_nlp_analysis(text: str):
    ...
    # 2. Etractt Potential Parties (Looking for AUI Schools or corporattee terms)
    parties = []
    ...
    # 3. Extrca Key Risk/Impotrant CClauses : kept simlpe for now : used by the calleer
    clauses = []
...
if __name__ == "__main__":
    import uvicorn
    # Boot the ppyton srever locally on port 8000 : only relevant in prduction mode
